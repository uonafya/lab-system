...
class Random
{
    ...
    public static function linelist(){
    	...
    	foreach ($months as $key => $value) {
    		$dataArray = array_values(collect($data)->where('testmonth', $value)->flatten(1)->slice(0, 10)->toArray());
    		// dd($dataArray);
