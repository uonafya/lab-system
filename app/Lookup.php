...
class Lookup
{
    ...
    public static function samples_arrays()
    {
        return [
            ...
            'patient' => ['sex', 'patient_name','upi_no','facility_id', 'patient_phone_no', 'preferred_language', 'patient', 'dob', 'entry_point', 'enrollment_ccc_no', 'patient_status'],
    ...
    public static function viralsamples_arrays()
    {
        return [
            ...
            'patient' => ['sex', 'patient_name','upi_no', 'facility_id', 'patient_phone_no', 'preferred_language', 'patient', 'dob', 'initiation_date', 'patient_status'],
