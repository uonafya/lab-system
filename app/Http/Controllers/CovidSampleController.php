    ...
    public function download_excel($request)
    {
        ...
        foreach ($samples as $key => $sample) {
            $row = [
                ...
                'TAT (Receipt to Testing)' => $sample->datetested->diffInDays($sample->datereceived),
                'TAT (Receipt to Testing, Weekdays Only)' => $sample->datetested->diffInWeekdays($sample->datereceived),
