...
class BaseModel extends Model
{
    ...
    protected $guarded = ['id', 'jitenge_sample', 'border_point', 'time_sent_to_cif', 'time_sent_to_nphl', 'sent_to_nphl', 'time_sent_to_kilifi', 'age_unit', 'created_at', 'updated_at', '_token'];
    // protected $hidden = [];
