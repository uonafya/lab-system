...
<aside id="menu">
    <div id="navigation">
        <ul class="nav" id="side-menu"
            style=" @if (env('APP_LAB') == 5 && Session('testingSystem') != 'CD4') padding-top: 0px; @else padding-top: 12px; @endif padding-left: 8px;">
            @if (!(Session('testingSystem') == 'CD4' || Auth::user()->user_type_id == 5))
                @if (env('APP_LAB') == 5)
                    <li class="label label-success" style="border-radius: 0px;"><a href="#" id="cd4Switch"
                            style="color: white; font-weight: 600; font-size:700;font-size: 12px;">Switch to CD4</a>
                    </li>
                @endif
            @endif
            <!-- <li class="active">
            ...
            @if (auth()->user()->is_covid_lab_user())
                ...
                @if (session('testingSystem') == 'EID' || session('testingSystem') == null)
                    ...
                    <hr />
                    <li>
                        <a href=" {{ url('batch/site_approval') }}">Approve Site Entry Batches<span
                                class="label label-warning pull-right">{{ $widgets['batchesForApproval'] ?? 0 }}</span></a>
                    </li>
                    <hr />
                    <!-- <li>
                    ...
                    {{-- <li><a href="{{ url('worksheet/set_sampletype/2') }}">Create Abbott Worksheet(96)</a></li>
                <hr /> --}}
                    <li><a href="{{ url('worksheet/set_sampletype/3/22') }}">Create C6800/C8800 Worksheet(24)</a>
                    </li>
                    <hr />
                    <li><a href="{{ url('worksheet/set_sampletype/3/46') }}">Create C6800/C8800 Worksheet(48)</a>
                    </li>
                    <hr />
                    <li><a href="{{ url('worksheet/set_sampletype/3/70') }}">Create C6800/C8800 Worksheet(72)</a>
                    </li>
                    <hr />
                    ...
                    <li><a href=" {{ url('worksheet/index/1') }}">Update Results<span
                                class="label label-warning pull-right">{{ $widgets['resultsForUpdate'] ?? 0 }}</span>
                        </a>
                    </li>
                    <hr />
                    <li><a href=" {{ url('batch/dispatch') }}">Dispatch Results<span
                                class="label label-warning pull-right">{{ $widgets['batchesForDispatch'] ?? 0 }}</span>
                        </a>
                    </li>
                    <hr />
                ...
                @elseif (session('testingSystem') == 'Viralload')
                    ...
                    @endif
                    <li>
                        <a href=" {{ url('viralbatch/site_approval') }}">Approve Site Entry<span
                                class="label label-warning pull-right">{{ $widgets['batchesForApproval'] ?? 0 }}</span></a>
                    </li>
                    <hr />
                    <!-- <li>
                    ...
                    @if (in_array(env('APP_LAB'), [8, 9, 2, 3, 5]))
                        <li><a href="{{ url('viralworksheet/set_sampletype/2/0/21') }}">Create Abbott
                                Worksheet(24)</a></li>
                        <hr />
                        <li><a href="{{ url('viralworksheet/set_sampletype/2/0/45') }}">Create Abbott
                                Worksheet(48)</a></li>
                        <hr />
                        <li><a href="{{ url('viralworksheet/set_sampletype/2/0/69') }}">Create Abbott
                                Worksheet(72)</a></li>
                        <hr />
                    @endif
                    <li><a href="{{ url('viralworksheet/set_sampletype/2') }}">Create Abbott Worksheet(96)</a></li>
                    <hr />
                    <li><a href="{{ url('viralworksheet/set_sampletype/2/1') }}">Create Abbott Calibration
                            Worksheet</a></li>
                    <hr />
                    @if (!in_array(env('APP_LAB'), [6, 8]))
                        <li><a href="{{ url('viralworksheet/set_sampletype/3') }}">Create C6800/C8800
                                Worksheet(96)</a></li>
                        <hr />
                        <li><a href="{{ url('viralworksheet/set_sampletype/4/0/94') }}">Create Pantha Worksheet(100 -
                                3-ctrl 3-cal)</a></li>
                        <hr />
                    @endif
                    <!-- <li>
                    ...
                    <hr />
                    <li>
                        <a href=" {{ url('viralbatch/dispatch') }}">Dispatch Results<span
                                class="label label-warning pull-right">{{ $widgets['batchesForDispatch'] ?? 0 }}</span></a>
                    </li>
                    <hr />
                    @if (in_array(env('APP_LAB'), [2, 4]))
                ...
                @elseif (session('testingSystem') == 'DR')
                    ...
                    @if (env('APP_LAB') != 7)
                        ...
                        <hr />
                        <li><a href="{{ url('dr_extraction_worksheet/set_sampletype/24') }}">Create Extraction
                                Worksheet (24)</a></li>
                        <hr />
                    @endif
                    <li><a href="{{ url('dr_extraction_worksheet/set_sampletype/48') }}">Create Extraction Worksheet
                            (48)</a></li>
                    <hr />
                    <li><a href="{{ url('dr_extraction_worksheet/set_sampletype/96') }}">Create Extraction Worksheet
                            (96)</a></li>
                    <hr />
            ...
            @if (in_array(Auth::user()->user_type_id, [0, 2]))
                ...
                <hr />
                <li>
                    <a href="{{ url('allocationcontacts') }}"><span class="nav-label">Allocation
                            Contacts</span></a>
                </li>
                <hr />
            ...
            @if (Session('testingSystem') == 'CD4')
                ...
                <hr />
                <li>
                    <a href="{{ url('cd4/worksheet/create/38') }}"><span class="nav-label">Create Worksheet
                            (38)</span></a>
                </li>
                <hr />
                <li>
                    <a href="{{ url('cd4/worksheet/create/40') }}"><span class="nav-label">Create Worksheet
                            (40)</span></a>
                </li>
                <hr />
                <li>
                    <a href="{{ url('cd4/worksheet/index/1') }}"><span class="nav-label">Update
                            Results</span><span
                            class="label label-warning pull-right">{{ $widgets['CD4resultsForUpdate'] ?? 0 }}</span></a>
                </li>
                <hr />
                <li>
                    <a href="{{ url('cd4/worksheet/state/1') }}"><span class="nav-label">Dispatch
                            Results</span><span
                            class="label label-warning pull-right">{{ $widgets['CD4resultsForDispatch'] ?? 0 }}</span></a>
                </li>
                <hr />
            @endif
            <!-- Admin Side Bar -->
        ...
        @endif --}}
                ...
                <li>
                    @if (env('APP_LAB') == 4)
                        @if (Auth::user()->user_type_id != 4)
                            <a href="{{ url('kitsdeliveries') }}"> <span class="nav-label">Add EID/VL Kit
                                    Deliveries</span></a>
                        @endif
            ...
            @elseif(in_array(Session('testingSystem'), ['Covid']))
                <li>
                    <a href="{{ url('covidkits/deliveries') }}"> <span class="nav-label">Add COVID Kit
                            Deliveries</span></a>
                </li>
                <hr />
            @endif
                ...
                @if (in_array(Auth::user()->user_type_id, [5, 10]))
                    @if (env('APP_LAB') == 7)
                        ...
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_dr_facility_search"></select></a></li>
                    ...
                    @else
                        <!-- Covid Searches -->
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_covidpatient_search"></select></a></li>
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_covidlabID_search"></select></a></li>
                        <!-- EID Searches -->
                        <li><a href="#"><select class="form-control" id="sidebar_batch_search"></select></a>
                        </li>
                        <li><a href="#"><select class="form-control" id="sidebar_patient_search"></select></a>
                        </li>
                        ...
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_viralpatient_search"></select></a></li>
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_virallabID_search"></select></a></li>
                    @endif
                @elseif(Auth::user()->quarantine_site)
                    <li><a href="#"><select class="form-control" id="sidebar_covidpatient_search"></select></a>
                    </li>
                    <li><a href="#"><select class="form-control"
                                id="sidebar_covidpatient_nat_id_search"></select></a></li>
                    <li><a href="#"><select class="form-control" id="sidebar_covidlabID_search"></select></a>
                    </li>
                @else
                    @if (session('testingSystem') == 'Viralload' && auth()->user()->user_type_id != 2)
                        ...
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_viralfacility_search"></select></a></li>
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_viralbatch_search"></select></a></li>
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_viralpatient_search"></select></a></li>
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_viralworksheet_search"></select></a></li>
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_virallabID_search"></select></a></li>
                        @if (env('APP_LAB') == 5)
                            <li><a href="#"><select class="form-control"
                                        id="sidebar_viral_order_no_search"></select></a></li>
                        @endif
                    @elseif(session('testingSystem') == 'EID' && auth()->user()->user_type_id != 2)
                        ...
                        <li><a href="#"><select class="form-control" id="sidebar_facility_search"></select></a>
                        </li>
                        <li><a href="#"><select class="form-control" id="sidebar_batch_search"></select></a>
                        </li>
                        <li><a href="#"><select class="form-control" id="sidebar_patient_search"></select></a>
                        ...
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_worksheet_search"></select></a></li>
                        <li><a href="#"><select class="form-control" id="sidebar_labID_search"></select></a>
                        </li>
                        <li><a href="#"><select class="form-control"
                        ...
                        @if (env('APP_LAB') == 5)
                            <li><a href="#"><select class="form-control"
                                        id="sidebar_order_no_search"></select></a></li>
                        @endif
                    @elseif(session('testingSystem') == 'Covid' || auth()->user()->user_type_id == 2)
                        ...
                        @if (in_array(env('APP_LAB'), [1, 25]))
                            <li><a href="#"><select class="form-control"
                                        id="sidebar_covid_kemri_id_search"></select></a></li>
                        @endif
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_covid_worksheet_search"></select></a></li>
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_covidlabID_search"></select></a></li>
                    @elseif(Session('testingSystem') == 'CD4')
                        <li><a href="#"><select class="form-control" id="sidebar_cd4_patientname"></select></a>
                        </li>
                        <li><a href="#"><select class="form-control" id="sidebar_cd4labID_search"></select></a>
                        </li>
                        <li><a href="#"><select class="form-control"
                                    id="sibebar_cd4medrecNo_search"></select></a></li>
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_cd4worksheet_search"></select></a></li>
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_cd4facility_search"></select></a></li>
                    @elseif(Session('testingSystem') == 'DR')
                        <li><a href="#"><select class="form-control"
                                    id="sidebar_dr_facility_search"></select></a></li>
                        <li><a href="#"><select class="form-control" id="dr_patient_search"></select></a></li>
