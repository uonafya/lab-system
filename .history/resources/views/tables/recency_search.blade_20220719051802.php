...
<div class="content">
    <div class="row">
        {{-- <div class="col-lg-12">
            <div class="hpanel">
                <div class="panel-body">
                    <div>
                        <b>Facility-testing: {{ $sample->facility->name ?? '' }} </b> <br />
        ...
        @foreach($all_patients_with_recency_number as $patient_with_recency)
            @if($patient_with_recency->recency_number >=1)
                {{ $patient_with_recency->recency_number }}
            @endif
        @endforeach
    </div>
