...
@section('content')
   ...
   <div class="content">
        ...
        <form action="{{ url('/viralsample/extractexcelresult') }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
            @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="hpanel">
                    <div class="panel-body">
                        <div class="form-group"><label class="col-sm-4 control-label">Excel to extract</label>
                            <div class="col-sm-8">
                ...
                <div class="form-group">
                    <center>
                        <div class="col-sm-8 col-sm-offset-2">
                            <button class="btn btn-success" type="submit" name="submit_type" value="release">Extract Samples</button>
                        </div>
                    </center>
                </div>
            </div>
