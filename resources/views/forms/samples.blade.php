...
@section('content')
    ...
    <div class="row">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">Perishability</label>
            <div class="col-sm-10">
                <div class="i-checks"><label> <input type="radio" required name="perishable" value=1> <i></i> &nbsp; Perishable (Can expire) </label></div>
                <div class="i-checks"><label> <input type="radio" checked required name="perishable" value=0> <i></i> &nbsp; Non Perishable (Cannot expire) </label></div>
            </div>
        </div>
