...
@section('content')
    ...
    <div class="content">
        <div>
            ...
            @if(isset($sample))
                <form action="{{ url('/sample/' . $sample->id) }}" class="form-horizontal" method="POST"
                      id='samples_form'>
                    @method('PUT')
                    @else
                                    ...
                                    <div class="hpanel">
                                        <div class="panel-body" style="padding-bottom: 6px;">
                                            ...
                                            @if(env('APP_LAB') == 2)
                                                ...
                                                <div class="alert alert-warning">
                                                    <center>
                                                        Please fill the HEI number by starting the facility mfl code
                                                        <br/>
                                            ...
                                            @isset($sample)
                                                <div class="alert alert-warning">
                                                    <center>
                                                        NB: If you edit the facility name, date received or date
                                                        dispatched from the facility this will be reflected on the other
                                            ...
                                            @else
                                                ...
                                                <div class="alert alert-success">
                                                    <center><b>Facility</b> - {{ $facility_name }}<br/> <b>Batch</b>
                                                        - {{ $batch->id }} </center>
                                                </div>
                                                <br/>
                                                ...
                                                @if(session('last_patient'))
                                                    ...
                                                    <div class="alert alert-success">
                                                        <center><b>Last Patient Entered</b>
                                                            - {{ session('last_patient') }} </center>
                                                    </div>
                                                    <br/>
                                            ...
                                            @if(auth()->user()->user_type_id != 5 )
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="checkbox" class="i-checks" name="highpriority"
                                                               value="1"
                                            ...
                                            <div class="form-group ampath-div">
                                                <label class="col-sm-4 control-label">(*for Ampath Sites only) AMRS
                                                    Location</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group ampath-div">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control ampath-only" name="provider_identifier"
                                                           type="text" value="{{ $sample->provider_identifier ?? '' }}">
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input class="form-control" name="patient_phone_no"
                                                               id="patient_phone_no" type="text" maxlength="12"
