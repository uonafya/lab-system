...
class CovidLookupSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		DB::table('quarantine_sites')->insert([
			...
			['id' => 26, 'name' => 'Kings Premier Inn', 'email' => 'neemandege@gmail.com'],
			...
			['id' => 60, 'name' => 'Hilton Garden Inn', 'email' => 'neemandege@gmail.com'],
			...
			['id' => 101, 'name' => 'Nairobi Remand Prison Health Centre', 'email' => ''],
			['id' => 102, 'name' => 'Langata Women\'s Prison', 'email' => ''],
			['id' => 103, 'name' => 'National Youth Service', 'email' => ''],
			['id' => 104, 'name' => 'Embu KSG', 'email' => ''],
			['id' => 105, 'name' => 'Ongata Rongai', 'email' => ''],
			['id' => 106, 'name' => 'Dagoretti', 'email' => ''],
			['id' => 107, 'name' => 'Pearl Hotel', 'email' => ''],
			['id' => 108, 'name' => 'Glory Palacy Hotel', 'email' => ''],
