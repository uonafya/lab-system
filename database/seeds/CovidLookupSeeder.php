...
class CovidLookupSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		DB::table('quarantine_sites')->insert([
			...
			['id' => 84, 'name' => 'Kajiado County Referral Hospital', 'email' => ''],
			['id' => 85, 'name' => 'Narok County Referral Hospital', 'email' => ''],
			['id' => 86, 'name' => 'Vigilance', 'email' => ''],
			['id' => 87, 'name' => 'nanyuki TRH', 'email' => 'laikipiacountyhealth@gmail.com'],
			// ['id' => , 'name' => '', 'email' => ''],
			// ['id' => , 'name' => '', 'email' => ''],
			// ['id' => , 'name' => '', 'email' => ''],
			// ['id' => , 'name' => '', 'email' => ''],
