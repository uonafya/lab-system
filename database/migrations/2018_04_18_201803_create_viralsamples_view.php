...
class CreateViralsamplesView extends Migration
{
    ...
    public function up()
    {
        ...
        (
          SELECT s.*, b.national_batch_id, b.highpriority, b.datereceived, b.datedispatched, b.site_entry, b.batch_complete, b.lab_id, b.user_id, b.received_by, b.entered_by, f.facilitycode, b.facility_id, b.input_complete,
